...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/banner-es-oscuro.svg?v=2">
  <img alt="Rubén García Domínguez · Ingeniero de IA aplicada. Llevo LLMs, visión y voz a producción, y construyo el producto que los rodea." src="assets/banner-es-claro.svg?v=2" width="100%">
</picture>
</a>
...
<a href="https://rubengarcia.pages.dev">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/banner-en-oscuro.svg?v=2">
  <img alt="Rubén García Domínguez · Applied AI engineer. I put LLMs, vision and voice into production, and build the product around them." src="assets/banner-en-claro.svg?v=2" width="100%">
</picture>
</a>
